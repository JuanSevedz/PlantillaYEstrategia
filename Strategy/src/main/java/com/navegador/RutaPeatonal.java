...
public class RutaPeatonal implements EstrategiaRuta {
    ...
    public String calcular(String origen, String destino) {
        try {
            ...
            URL url = new URL("https://api.openrouteservice.org/v2/directions/foot-walking"); // 👈 RUTA PEATONAL
            ...
            instrucciones.append("🚶 Instrucciones de ruta a pie:\n");
            ...
            e.printStackTrace();
            return "❌ Error al calcular la ruta a pie";
        }
    }

    // Método geocodificador (idéntico al que usaste en RutaCarretera)
