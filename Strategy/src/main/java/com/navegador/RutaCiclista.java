...
public class RutaCiclista implements EstrategiaRuta {
    ...
    public String calcular(String origen, String destino) {
        try {
            ...
            URL url = new URL("https://api.openrouteservice.org/v2/directions/cycling-regular");
            ...
            instrucciones.append("🚴 Instrucciones de ruta en bicicleta:\n");
            ...
            e.printStackTrace();
            return "❌ Error al calcular la ruta ciclista";
        }
    }
